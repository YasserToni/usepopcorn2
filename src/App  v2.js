...
export default function App() {
  ...
  // useEffect(function () {
  //   console.log('After inital rendering')
  // }, [])
  ...
  // useEffect(
  //   function () {
  //     console.log("After changing query");
  //   },
  //   [query]
  // );

  // console.log('During the rendering')
...
function NumResults({ movies, children }) {
  return (
...
function WatchMoviesList({ watched, onDeleteWatched }) {
  return (
    <ul className="list">
      {watched.map((movie) => (
        <WatchMovies movie={movie} onDeleteWatched={onDeleteWatched} />
      ))}
    </ul>
  );
}
function WatchMovies({ movie, onDeleteWatched }) {
  return (
    <li key={movie.imdbID}>
